...
const AIAssistant: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60]">
      ...
      {isOpen && (
        <div className="absolute bottom-20 right-0 w-[90vw] sm:w-[400px] h-[500px] bg-white rounded-3xl shadow-2xl border border-gray-100 flex flex-col overflow-hidden">
          ...
          <div className="p-4 bg-white border-t border-gray-100">
            <div className="flex space-x-2">
              <input value={input} onChange={(e) => setInput(e.target.value)} onKeyPress={(e) => e.key === 'Enter' && sendMessage()} placeholder="Tanyakan manfaat kombucha..." className="flex-grow px-4 py-3 bg-gray-100 rounded-xl text-sm focus:outline-none" />
